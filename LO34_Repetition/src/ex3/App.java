...
public class App {
    ...
    public static void fletAlleHeltal(String fileName1, String fileName2, String fileNameNy){
        File fil1 = new File("LO34_Repetition/src/ex3/" + fileName1);
        File fil2 = new File("LO34_Repetition/src/ex3/" + fileName2);
        File mergedfile = new File("LO34_Repetition/src/ex3/" + fileNameNy);
